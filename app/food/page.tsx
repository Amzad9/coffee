              ...
              >
                ...
                <div className="p-6 sm:p-8 grow flex flex-col">
                  ...
                  <div className="flex items-center justify-between gap-3 mt-auto pt-4 border-t border-amber-200">
                    ...
                    <button
                      className="px-4 sm:px-6 py-2 sm:py-3 bg-linear-to-r from-amber-500 to-amber-600 text-white font-semibold rounded-lg hover:from-amber-600 hover:to-amber-700 transition-all duration-300 transform hover:scale-105 text-sm sm:text-base whitespace-nowrap"
                    >
                      Order Online
                    </button>
                  </div>
